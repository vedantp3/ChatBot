...
# IMPORTANT: Replace "YOUR_TOGETHER_AI_API_KEY" with your actual key from your Together.ai account.
TOGETHER_API_KEY = "tgp_v1_P219VY9RYZhULscfC_wx7Vt9Q6ZYf5CpqU-3-Smxrps" 
...
def discover_all_site_links(root_url: str) -> list[str]:
    ...
    # A limit to prevent infinitely crawling very large websites
    ...
    while urls_to_visit and len(all_site_links) < max_pages_to_scrape:
        ...
        try:
            ...
            for link_tag in soup.find_all('a', href=True):
                ...
                # Properly join relative and absolute links
                full_url = urljoin(url, href).split("#")[0]

                # Check if the link belongs to the same domain and hasn't been processed
...
def load_data_and_create_retriever(root_url: str):
    ...
    if os.path.exists(specific_persist_dir):
        ...
        # Use the new crawling function to get all site links
...
if __name__ == "__main__":
    ...
    if models_loaded_successfully:
        ...
        print(f"Waitress server starting on http://0.0.0.0:5000")
        print("-" * 50)
